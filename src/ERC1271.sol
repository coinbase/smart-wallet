...
abstract contract ERC1271 is EIP712 {
    bytes32 private constant DOMAIN_AND_VERSION_TYPEHASH = keccak256("Coinbase Smart Account 1");
        ...
        returns (bytes4 result)
    {
        ...
        bytes memory messageData = abi.encodePacked(
            ...
            keccak256(abi.encode(DOMAIN_AND_VERSION_TYPEHASH, keccak256(abi.encode(hash))))
        );
